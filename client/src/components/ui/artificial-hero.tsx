    ...
    <div ref={containerRef} style={{ width: '100%', height: '100vh', background: '#000', position: 'relative' }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <a href="#roadmap" style={{ color: 'white', textDecoration: 'none', opacity: 0.9 }}>
            Roadmap
          </a>
          <a href="#tecnologia" style={{ color: 'white', textDecoration: 'none', opacity: 0.9 }}>
            Tecnologia
          </a>
          <a href="#equipe" style={{ color: 'white', textDecoration: 'none', opacity: 0.9 }}>
            Equipe
          </a>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          Technology & Innovation by RME Energy
        </div>
      </div>
